...
with tab3:
    def create_assessment_results():
        ...
        st.markdown(f'<p><span style="font-weight: bold;">GDT Scale:</span> {gdt_scale}</p>', unsafe_allow_html=True)
        ...
        # Condition 1 section
        st.markdown('<h3 style="color: #fbd57a; font-size: 1.2rem;">Condition 1: Model Accuracy Assessment</h3>', unsafe_allow_html=True)
        ...
        st.markdown('<h3 style="color: #fbd57a; font-size: 1.2rem;">Conditions 2-3: Model Resolution Validation</h3>', unsafe_allow_html=True)
        ...
        st.markdown('<h3 style="color: #fbd57a; font-size: 1.2rem;">Performance Comparison: Model G(t) vs Model G(0)</h3>', unsafe_allow_html=True)
        ...
        if can_calculate_condition1 and can_calculate_condition2 and can_calculate_condition3:
            st.markdown('<h2 style="color: #fbd57a; font-size: 1.4rem;">Visual Score: Model Update Assessment</h2>', unsafe_allow_html=True)   
        ...
        st.markdown('<h2 style="color: #FFB433; font-size: 1.4rem;">Download Assessment Results</h2>', unsafe_allow_html=True)
