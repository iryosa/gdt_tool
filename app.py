...
with tab3:
    def create_verification_results():
        ...
        st.markdown('<h2 style="color: #E5E1DA; font-size: 1.4rem;">DQ Elements Summary</h2>', unsafe_allow_html=True)
        ...
        st.markdown('<h2 style="color: #FFB433; font-size: 1.4rem;">Decision Model based on Mandatory DQ Elements</h2>', unsafe_allow_html=True)
        ...
        if g0_lod != "N/D" and gt_lod != "N/D":
            ...
            st.write(f"**Condition 2. LoD Verification:** {lod_comparison}")
            st.caption("Indicates whether the LoD remains consistent between models")
        else:
            st.write("**Condition 2. LoD Verification:** Not calculated")
        ...
        if st.session_state.get('g0_model_resolution') is not None and st.session_state.get('gt_model_resolution') is not None:
            ...
            st.write(f"**Condition 3: Resolution Verification:** {resolution_comparison}")
            st.caption("Indicates whether the model resolution has improved or declined over time")
        else:
            st.write("**Condition 3: Resolution Verification:** Not calculated")
